...
func testParser(t *testing.T, xmlData string) {
...
<mapper namespace="test">
    <update id="updateBatchMediaSlotDailyStatisticsOriginal">
        <foreach collection="list" item="item" separator=";">
            update tb_account_report_month
            <set>
                <if test="item.appId != null">app_id = #{item.appId},</if>
                <if test="item.slotId != null">slot_id = #{item.slotId},</if>
            </set>
            where id = #{item.id}
        </foreach>
    </update>
...
func TestParserIf2(t *testing.T) {
	testParser(t, `<mapper namespace="Test">
...
//
//// 测试insert
//func TestParseInsertXml(t *testing.T) {
//	testParser(t,
//		`<mapper namespace="test">
//    <insert id="insert" parameterType="cn.com.duiba.prism.monitor.elasticsearch.entity.AlertPolicyEntity" keyProperty="id" useGeneratedKeys="true">
//        insert into tb_es_alert_policy
...
//    </insert>
//</mapper>`,
//		" into tb_es_alert_policy ( id,  instance_id,  metric,  config,  threshold,  gmt_create,  gmt_modifiedvalues ( ?,  ?,  ?,  ?,  ?,  ?,  ?);",
//	)
//}
//
